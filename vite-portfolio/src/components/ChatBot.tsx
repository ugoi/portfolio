...
const ChatBot = () => {
  ...
  return (
    <div className="fixed bottom-6 right-5 z-50">
      ...
      {/* Chat window */}
      {isOpen && (
        <div className="absolute bottom-8 right-0 w-[90vw] sm:w-96 h-96 bg-zinc-900/90 backdrop-blur-lg border border-white/10 rounded-lg shadow-xl flex flex-col overflow-hidden">
